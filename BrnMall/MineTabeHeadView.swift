...
class MineCouponView: UIView {
	...
	override init(frame: CGRect) {
		super.init(frame: frame)
		btn = MineUpImageDownText(frame: CGRectZero, title: "我的收藏", imageName: "v2_my_coupon_icon")
		addSubview(btn)
	}
...
class MineMessageView: UIView {
	...
	override init(frame: CGRect) {
		super.init(frame: frame)
		btn = MineUpImageDownText(frame: CGRectZero, title: "我的资产", imageName: "v2_my_monney_icon")
		addSubview(btn)
	}
