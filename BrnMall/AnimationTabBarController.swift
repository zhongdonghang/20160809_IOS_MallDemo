...
class AnimationTabBarController: UITabBarController {
	...
	var iconsImageName: [String] = ["v2_home", "v2_brand", "v2_order", "shopCart", "v2_my"]
	var iconsSelectedImageName: [String] = ["v2_home_r", "v2_brand_r", "v2_order_r", "shopCart_r", "v2_my_r"]
	...
	func searchViewControllerDeinit() {
		if shopCarIcon != nil {
			...
			redDotView.frame = CGRectMake(21 + 1, -3, 16, 16)
	...
	func createCustomIcons(containers: [String: UIView]) {
		if let items = tabBar.items {
			...
			for (index, item) in items.enumerate() {
				...
				let imageY: CGFloat = 6
				let imageH: CGFloat = 24
